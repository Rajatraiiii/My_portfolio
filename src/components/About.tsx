        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          >
            <p className="text-lg leading-relaxed text-gray-300">
              I’m a 3rd-year at VIT Vellore,driven by curiosity and a passion 
              for solving real-world problems through data and technology.
            </p>
            <h3 className="text-2xl font-bold text-white md:text-3xl">
              My expertise
            </h3>
            <p className="text-lg leading-relaxed text-gray-300">
              I specialize in data analysis, frontend development, and AI/ML, 
              with hands-on experience in tools like Power BI, Tableau, Excel, 
              and programming in Python, R, and JavaScript. My foundation in 
              statistics and probability helps me blend analytical rigor with 
