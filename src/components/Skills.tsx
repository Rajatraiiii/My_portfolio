...
const Skills: React.FC = () => {
  const skills = [
    { name: "Python", level: 5, icon: <Code className="w-8 h-8" /> },
    { name: "JavaScript", level: 5, icon: <Braces className="w-8 h-8" /> },
    { name: "HTML", level: 5, icon: <Braces className="w-8 h-8" /> },
    { name: "CSS", level: 5, icon: <Paintbrush className="w-8 h-8" /> },
    { name: "React.js", level: 5, icon: <Zap className="w-8 h-8" /> },
    { name: "Database", level: 5, icon: <Database className="w-8 h-8" /> },
    { name: "MySQL", level: 5, icon: <Database className="w-8 h-8" /> },
    { name: "Docker", level: 4, icon: <Boxes className="w-8 h-8" /> },
    { name: "Git & GitHub", level: 5, icon: <GitBranch className="w-8 h-8" /> },
    { name: "Power BI", level: 4, icon: <BarChart className="w-8 h-8" /> },
    { name: "Excel", level: 4, icon: <FileSpreadsheet className="w-8 h-8" /> },
    { name: "R", level: 3, icon: <Sigma className="w-8 h-8" /> },
    { name: "Tableau", level: 4, icon: <BarChart className="w-8 h-8" /> },
  ];
