...
import Rajat from "../assets/rajat1.png";
      ...
      <div className="relative z-10 px-4 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            Hi, I'm <span className="text-[#1C92D2]">Rajat</span>
          </motion.h1>
          ...
          >
            Data Analysis | Frontend developer | AI/ML enthusiast
          </motion.p>
          ...
          >
            "Aspiring Data Scientist with strong foundations in data analytics, visualization, and machine learning. Dedicated to transforming raw data into impactful solutions."
          </motion.p>
          ...
          >
            <motion.a
              href="https://github.com/Rajatraiiii"
              target="_blank"
            ...
            <motion.a
              href="https://www.linkedin.com/in/rajat-rai-96151628a/"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.2, color: "#1C92D2" }}
              className="text-gray-400 hover:text-[#1C92D2] transition-colors"
            ...
            <motion.a
              href="mailto:rairajat280@gmail.com"
              whileHover={{ scale: 1.2, color: "#1C92D2" }}
              className="text-gray-400 hover:text-[#1C92D2] transition-colors"
            >
              <Mail size={24} />
